...
function openModalForCreate() {
    ...
    document.getElementById("fileLabelContainer").textContent = "Upload Exam File (.json)";
    document.getElementById("fileFieldInstructionText").textContent = "Select a question configuration array file.";
...
function triggerEditModal(data, event) {
    ...
    document.getElementById("examJsonFile").value = "";
    document.getElementById("fileLabelContainer").textContent = "Change / Replace Document (.json)";
