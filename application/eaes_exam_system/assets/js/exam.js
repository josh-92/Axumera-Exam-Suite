(function () {
    ...
    function loadQuestion(index) {
        ...
        if (q.is_passage) {
            ...
            if (q.paragraph && q.paragraph.trim() !== "") {
                paragraphContainer.innerHTML = "<strong>Information:</strong><br>" + q.paragraph;
            ...
            order.forEach((key, i) => {
                ...
                span.innerHTML = (displayLetters[i] || key.toUpperCase()) + '. ' + value;
    ...
    function renderOverviewGrid() {
        ...
        examData.forEach((q, index) => {
            ...
            if (q.is_passage) {
                box.innerHTML = `<span>${q.roman_id}</span>`;
    ...
    function initIntegrity() {
        ...
        function armListeners() {
            ...
            document.addEventListener('visibilitychange', () => {
                if (document.hidden) reportViolation('tab_hidden', true);
            });
