...
// Derive "today" from the same MySQL clock the inserts use — PHP and MySQL
// can disagree about the date near midnight when their timezones differ
// (e.g. Europe/Berlin vs Africa/Nairobi), which made this flaky.
$today = $server->query('SELECT DATE(NOW())')->fetchColumn();
