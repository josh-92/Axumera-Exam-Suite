...
<header class="admin-header">
    ...
    <nav class="admin-nav">
        ...
        <a href="admin_students.php" class="<?php  echo $J_Lw8 === 'admin_students.php' ? 'active' : ''; ?>">Students</a>
        <a href="admin_settings.php" class="<?php  echo $J_Lw8 === 'admin_settings.php' ? 'active' : ''; ?>">Settings</a>
